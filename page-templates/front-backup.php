...
<section class="home-sections communities">
	<header class="home-grid grid-x grid-padding-x">
		<h2 class="main-heading shrink h3"><span class="first-line">Our Ministries serve</span> <span class="title-word">Communities</span> in various spheres and stages of life</h2>
	</header>
	<div class="home-grid">
        ...
        <a class="home-cell" href="#"><img src="https://unsplash.it/g/300/200/?image=14" alt="young professionals"><label class="label">Young Professionals</label></a>
...
<section class="home-sections touchpoints">
	...
	<div class="training">
		<header class="home-grid">
			<h3 class="main-heading"><span class="first-line">We Provide</span> <span class="title-word">Training</span> through coaching, courses &amp; retreats…</h3>
		</header>
	...
	<div class="missions">
		<h3 class="main-heading">…and <strong>mission projects</strong> beyond Singapore</h3>
